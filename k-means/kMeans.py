...
def distEclud(vecA, vecB):
    return sqrt(sum(power(vecA-vecB, 2)))# Euclidean distance. other distance metrics is also ok.
...
# The dataset and the number of clusters to generate are the only
...
def kMeans(dataSet, k, distMeas=distEclud, createCent=randCent):
    ...
    # This error is the distance from the cluster centroid to the current point. We will use this error later on to measure how good our clusters art. 
    clusterAssment = mat(zeros((m,2)))
    # find k centroids randomly
